...
def build_user_context(
    ...
    return {
        ...
        "capital":
            float(
                safe_get(user, "capital", 0)
            ),

        "savings":
            float(
                safe_get(user, "savings", 0)
            ),

        "monthly_income":
            float(
                safe_get(user, "monthly_income", 0)
            ),
...
def build_portfolio_context(
    ...
    return {
        ...
        "crypto_exposure":
            round(crypto_exposure, 2),

        "stocks_exposure":
            round(stocks_exposure, 2),

        "real_estate_exposure":
            round(real_estate_exposure, 2),

        "crypto_ratio":
            round(crypto_ratio, 4),
    }
